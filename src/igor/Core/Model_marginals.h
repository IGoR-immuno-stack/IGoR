...
public:
 ...
 private:
	//std::pair<std::list<std::pair<Rec_Event_name,size_t>>,std::shared_ptr<double>> compute_event_marginal_probability(Rec_Event_name , const Model_Parms& ) const;
	//std::pair<std::list<std::pair<Rec_Event_name,size_t>>,std::shared_ptr<double>> compute_event_marginal_probability(Rec_Event_name , const std::set<Rec_Event_name>& , const Model_Parms& ) const;
	std::pair<std::list<std::pair<Rec_Event_name,size_t>>,std::shared_ptr<double>> compute_event_marginal_probability(Rec_Event_name , const std::set<Rec_Event_name>& , const Model_Parms& ,const std::map<Rec_Event_name,int>& , const std::map<Rec_Event_name,std::vector<std::pair<std::shared_ptr<const Rec_Event>,int>>>& , const std::map<Rec_Event_name,std::list<std::pair<std::shared_ptr<const Rec_Event>,int>>>& ) const;
	...
	size_t compute_size(const Model_Parms& ) const;
