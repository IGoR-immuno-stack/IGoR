...
void Insertion::iterate_initialize_Len_proba(int considered_junction, std::map<int, double> &length_best_proba_map,
...
void Insertion::update_event_internal_probas(const Marginal_array_p &, const std::unordered_map<std::string, int> &)
{
    // TODO: implement
}
