...
public:
    ...
    void load_VJanchors(map<string, size_t> flnV_CDR3_anchors,
                        map<string, size_t> flnJ_CDR3_anchors);
    ...
    void
    set_sorted_alignments(map<int, pair<string, map<Gene_class, vector<Alignment_data>>>> *pointer);
