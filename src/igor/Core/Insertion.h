 ...
 * \version 1.0
 *
 *  The Insertion RecEvent models the distribution of junctional insertion
 * length during the V(D)J recombination process.
 *
 */
...
private:
    ...
    int insertions;
    int new_index;
    std::map<int, double> upper_bound_per_ins; // Contains the probability upper bound for each
