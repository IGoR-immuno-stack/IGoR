...
private:
	inline double iterate_common(double , int , int , Index_map& ,const std::map<Rec_Event_name,std::vector<std::pair<std::shared_ptr<const Rec_Event>,int>>>& ,const Marginal_array_p&);
