 ...
 */
map<int,vector<Alignment_data>> read_alignments_seq_csv(const string &filename , double score_threshold , bool allow_in_dels ){
	ifstream infile(filename);
	if(!infile){
		throw runtime_error("File not found: "+filename);
	}
...
map<int,pair<string,map<Gene_class,vector<Alignment_data>>>> read_alignments_seq_csv(const string &filename , Gene_class aligned_gene , double score_threshold , bool allow_in_dels , const vector<pair<const int , const string>> &indexed_sequences ){
...
map<int,pair<string,map<Gene_class,vector<Alignment_data>>>> read_alignments_seq_csv(const string &filename , Gene_class aligned_gene , double score_threshold , bool allow_in_dels , vector<pair<const int , const string>> indexed_sequences , map<int,pair<string,map<Gene_class,vector<Alignment_data>>>> sorted_alignments){
...
map<int,pair<string,map<Gene_class,vector<Alignment_data>>>> read_alignments_seq_csv_score_range(const string &filename , Gene_class aligned_gene , double score_range , bool allow_in_dels , vector<pair<const int , const string>> indexed_sequences ){
	map<int,pair<string,map<Gene_class,vector<Alignment_data>>>> sorted_alignments;
