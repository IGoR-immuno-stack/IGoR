 ...
 * \version 1.0
 *
 * The Counter abstract class provides an interface to collect individual
 * scenarios statistics and aggregate them in various ways.
 */
class Counter
{
public:
    ...
    virtual void count_scenario(long double, double, const std::string &, Seq_type_str_p_map &,
...
protected:
    ...
    // TODO create a unique identifier of the counter? Make something up to
    // prevent to have twice the same counter??
};
