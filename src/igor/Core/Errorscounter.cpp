...
void Errors_counter::count_scenario(long double scenario_error_w_proba, double scenario_proba,
...
void Errors_counter::initialize_counter(const Model_Parms &model_parms,
