...
CORE_EXPORT std::vector<std::tuple<int,std::string,std::map<Gene_class , std::vector<Alignment_data>>>> get_best_aligns (const std::vector<std::tuple<int,std::string,std::map<Gene_class , std::vector<Alignment_data>>>>&, Gene_class);
