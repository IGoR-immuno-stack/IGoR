...
CORE_EXPORT std::unordered_map<int,std::pair<std::string,std::unordered_map<Gene_class,std::vector<Alignment_data>>>> read_alignments_seq_csv(std::string , Gene_class , double , bool , std::vector<std::pair<const int,const std::string>>);
CORE_EXPORT std::unordered_map<int,std::pair<std::string,std::unordered_map<Gene_class,std::vector<Alignment_data>>>> read_alignments_seq_csv(std::string , Gene_class , double , bool , std::vector<std::pair<const int,const std::string>>, std::unordered_map<int,std::pair<std::string,std::unordered_map<Gene_class,std::vector<Alignment_data>>>>);
CORE_EXPORT std::unordered_map<int,std::pair<std::string,std::unordered_map<Gene_class,std::vector<Alignment_data>>>> read_alignments_seq_csv_score_range(std::string , Gene_class , double , bool , std::vector<std::pair<const int,const std::string>>);
...
CORE_EXPORT std::forward_list<std::pair<const int,const std::string>> read_indexed_seq_csv(std::string);
CORE_EXPORT std::vector<std::pair<const int , const std::string>> read_indexed_csv(std::string);
CORE_EXPORT std::vector<std::pair<const int,const std::string>> read_fasta(std::string);
CORE_EXPORT std::vector<std::pair<std::string,std::string>> read_genomic_fasta(std::string);
CORE_EXPORT std::vector<std::pair<const int,const std::string>> read_txt(std::string);
CORE_EXPORT std::unordered_map<std::string,size_t> read_gene_anchors_csv(std::string,std::string separator= ";");
CORE_EXPORT std::unordered_map<std::string,std::pair<int,int>> read_template_specific_offset_csv(std::string,std::string separator= ";");
CORE_EXPORT void write_indexed_seq_csv(std::string , std::vector<std::pair<const int,const std::string>>);
CORE_EXPORT Int_Str nt2int(std::string);
...
CORE_EXPORT std::vector<std::pair<const int , const std::string>> sample_indexed_seq( std::vector<std::pair<const int , const std::string>>,const size_t);
