...
void Pgen_counter::dump_sequence_data(int seq_index , int iteration_n ){
	...
	for(map<Int_Str,pair<double,long double>>::const_iterator iter = sequence_Pgens_map.begin() ; iter != sequence_Pgens_map.end() ; ++iter){
		if(output_Pgen_estimator){
