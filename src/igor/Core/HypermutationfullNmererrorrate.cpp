...
Hypermutation_full_Nmer_errorrate::Hypermutation_full_Nmer_errorrate(size_t n, Gene_class g1, Gene_class g2, double d, size_t s)
    : Error_rate()
{
}

Hypermutation_full_Nmer_errorrate::Hypermutation_full_Nmer_errorrate(size_t n, Gene_class g1, Gene_class g2, std::vector<double> v, size_t s)
    : Error_rate()
{
}

Hypermutation_full_Nmer_errorrate::Hypermutation_full_Nmer_errorrate(
        std::unordered_map<int, Matrix<double>> rates_map)
...
double Hypermutation_full_Nmer_errorrate::compare_sequences_error_prob(
        double scenario_proba, const std::string &sequence,
